...
public final class CreateItemFabricatorInventoryCompat {
    private CreateItemFabricatorInventoryCompat() {
    }
    ...
    public static ItemStack extractFromFabricator(Object handler, int slot, int amount) {
        ...
        return isFabricator(stack) ? ItemFabricatorItem.selectedItemStack(stack, amount) : ItemStack.EMPTY;
    }

    private static boolean isFabricator(ItemStack stack) {
        return !stack.isEmpty() && stack.getItem() instanceof ItemFabricatorItem;
    }
