...
public class DayControllerModel extends BakedModelWrapper<BakedModel> {
    private static BakedModel originalModel;

    public DayControllerModel(BakedModel originalModel) {
        super(originalModel);
        DayControllerModel.originalModel = originalModel;
    }
