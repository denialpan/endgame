...
public class GalaxyIngotGeneratedModel extends BakedModelWrapper<BakedModel> {
    private static BakedModel originalModel;

    public GalaxyIngotGeneratedModel(BakedModel originalModel) {
        super(originalModel);
        GalaxyIngotGeneratedModel.originalModel = originalModel;
    }
